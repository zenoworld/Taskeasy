...
const DataCard = ({ data, setOpenDetailCard }) => {
    ...
    return (
        <div className="card">
            ...
            <div className='h-1/2 w-full overflow-y-auto scrollbar flex items-center'>
            ...
            <div className='w-full flex justify-center gap-8 sm:gap-0 sm:justify-between items-center relative'>
                <button
                    className={`
